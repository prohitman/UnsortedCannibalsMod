...
public class YearnCannibal extends PathfinderMob implements GeoEntity, Enemy {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new CannibalMeleeAttackGoal(this, 0.85D, true, 14, 20, 0.5));
    ...
    public static boolean checkYearnSpawnRules(EntityType<? extends YearnCannibal> pType, ServerLevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) {
    ...
    public void tick() {
        ...
        if(!this.level().isClientSide){
            this.setIsRunning(this.moveControl.getSpeedModifier() > 0.5);
        } else {
