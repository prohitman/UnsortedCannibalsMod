...
public class YearnModel extends DefaultedEntityGeoModel<YearnCannibal> {
    public YearnModel() {
        super(new ResourceLocation(UnsortedCannibalsMod.MODID, "yearn"));
    }

    @Override
    public void setCustomAnimations(YearnCannibal animatable, long instanceId, AnimationState<YearnCannibal> animationState) {
